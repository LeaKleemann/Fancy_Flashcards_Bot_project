...
def question_distance(input_text_resp):
    ...
    def get_distance(all_questions, message):
        ...
        #return all_questions[max_idx], cosine_sim[max_idx]
        return best_question, cosinus_wert
    
    all_questions=load_data()
    best_question, cosinus_wert = get_distance(all_questions, message)
